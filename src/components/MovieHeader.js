...
const MovieHeader = (props) => {
  const appTitle = useSelector(newStore=>newStore.movieReducer.appTitle);
  const displayFavorites = useSelector(newStore=>newStore.favoriteReducer.displayFavorites);
